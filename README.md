...
| **CLO5** | ใช้บริการ Cloud Computing (Google Cloud Platform) สำหรับการพัฒนาและ Deploy แบบจำลองได้ |
| **CLO6** | สร้าง Container ด้วย Docker และพัฒนา REST API ด้วย FastAPI สำหรับ Deploy แบบจำลองได้ |
| **CLO7** | ตรวจสอบและวิเคราะห์ประสิทธิภาพของแบบจำลองที่ Deploy แล้วได้ |
| **CLO8** | ตรวจจับ Data Drift และ Model Drift เพื่อกำกับควบคุมการใช้แบบจำลองได้ |
...
**📌 CLO ที่เกี่ยวข้อง:** CLO1-CLO8 (ทุก CLO)
