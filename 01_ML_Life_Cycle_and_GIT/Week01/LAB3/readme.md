...
## 🧪 **ตัวอย่างโจทย์ให้นักศึกษาเลือก หรือคิดเอง**

| หมวดหมู่     | Dataset ตัวอย่าง      | โจทย์               |
| ------------ | --------------------- | ------------------- |
| 🌸 ดอกไม้    | Iris dataset          | ทำนายชนิดดอกไม้     |
| 🍷 Wine      | Wine dataset          | ทำนายคุณภาพไวน์     |
| 🏥 สุขภาพ    | Diabetes dataset      | ทำนายเบาหวาน        |
| 💳 Bank Loan | Breast cancer dataset | ทำนายอนุมัติเงินกู้ |
| 🧠 MNIST     | Digits dataset        | ทำนายเลข 0–9        |
| 🧪 Kaggle    | หา dataset เอง        | ✔ Bonus คะแนนเพิ่ม  |
