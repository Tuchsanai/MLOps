...
# %% [markdown]
# # 🔑 วิธีการขอ API Key จาก Google Gemini
#
# ## 📌 ขั้นตอนการขอ API Key
#
# ### ขั้นตอนที่ 1: เข้าสู่ Google AI Studio
#
# 1. เปิดเว็บเบราว์เซอร์แล้วไปที่ **[Google AI Studio](https://aistudio.google.com/)**
# 2. ลงชื่อเข้าใช้ด้วย **Google Account** ของคุณ
#
#
# ---
#
...
#
# 1. คลิกที่เมนู **"Get API Key"** (รับ API Key) ที่แถบด้านซ้าย
# 2. คลิกปุ่ม **"Create API Key"**
# 3. เลือก Google Cloud Project ที่ต้องการ (หรือสร้างใหม่)
# 4. ระบบจะสร้าง API Key ให้โดยอัตโนมัติ
#
# ---
#
# ### ขั้นตอนที่ 3: คัดลอก API Key
#
# 1. เมื่อได้ API Key แล้ว ให้คลิกปุ่ม **"Copy"** เพื่อคัดลอก
# 2. **⚠️ สำคัญ:** เก็บ API Key ไว้ในที่ปลอดภัย อย่าแชร์ให้ผู้อื่น
#
#

# %%
# กำหนด API Key และ Model
API_KEY = "AIzaSyD_6Q85aQEN0X4Kle-wzncdGtXfG0BDGTY"  # ใส่ API Key ของคุณ
